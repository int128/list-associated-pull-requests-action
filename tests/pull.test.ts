...
//
// You can update this from https://docs.github.com/en/graphql/overview/explorer with:
// {
//   "owner": "int128",
//   "name": "list-associated-pull-requests-action",
//   "number": 98
// }
const fixturePullRequestCommitsQuery = {
  data: {
    rateLimit: {
      cost: 1,
    },
...
test('calculate', () => {
  const commitsQueryList: PullRequestCommitsQuery[] = [fixturePullRequestCommitsQuery.data]
